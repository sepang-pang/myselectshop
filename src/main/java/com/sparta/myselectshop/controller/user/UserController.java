package com.sparta.myselectshop.controller.user;
...
public class UserController {
    ...
    public String signup(@Valid SignupParam param, BindingResult bindingResult) {
        // Validation 예외처리
    ...
    @ResponseBody
    public UserInfoParam getUserInfo(@AuthenticationPrincipal UserDetailsImpl userDetails) {
